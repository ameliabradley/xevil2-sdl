...
void Game::intro() {
  ...
  msg 
    ...
    << "Copyright(C) 1994,1999 Steve Hardt and Michael Judge"
    << std::ends;
  locator.message_enq(msg.str());
  ...
  std::cout 
    ...
    << "Copyright(C) 1994,1999 Steve Hardt and Michael Judge" << std::endl
    << std::endl;  
  std::cout 
    << "This version of XEvil is SHAREWARE." << std::endl
    << "XEvil comes with absolutely no warranty." << std::endl;  
  std::cout 
    << "Type 'xevil -info' for shareware information and information on no warranty." << std::endl
