...
public:
  ...
  static Boolean ninja_team(LocatorP,PhysicalP,PhysicalP,void *);
...
Boolean Scenarios::dog_team(LocatorP,PhysicalP p1,PhysicalP p2,void *) {
...
void Hive::new_level(int level,WorldP world,LocatorP locator,
  ...
  // So Aliens and Huggers are fristd::ends.
...
void ThePound::new_level(int level,WorldP,LocatorP locator,
                         ...
                         std::ostrstream &lStr,std::ostrstream &lTitleStr,
                         IPhysicalManagerP manager,int) {
  locator->add_team(Scenarios::dog_team,NULL,NULL);
...
void JapanTown::new_level(int level,WorldP,LocatorP locator,
                         ...
                         std::ostrstream &lStr,std::ostrstream &lTitleStr,
                         IPhysicalManagerP manager,int) {
  locator->add_team(JapanTown::ninja_team,NULL,NULL);
...
Boolean JapanTown::ninja_team(LocatorP,PhysicalP p1,PhysicalP p2,void *) {
